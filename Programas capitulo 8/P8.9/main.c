...
void Lectura(propiedades A[], int T)
 /* Esta función se utiliza para leer un arreglo unidimensional de tipo estructura propiedadesde T elementos. */
 {
     int I;
     for (I=0; I<T; I++)
     {
 ...
 void F2(propiedades A[], int T)
  ...
  respecto al monto, esta función genera un listado de todas las propiedades disponibles para renta. */
  {
      int I;
      float li, ls;
      char zon[20];
